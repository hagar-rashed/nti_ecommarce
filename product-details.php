...
if(isset($_GET['pro'])){
    if($_GET['pro'] && is_numeric($_GET['pro'])){
      $pro = new product;
      $pro->setId($_GET['pro']);
      $proBeforeFetch = $pro->singleProduct();
      if($proBeforeFetch){
        $products = $proBeforeFetch->fetch_object();
                        ...
                        <div class="product-details-content">
                            ...
                            <div class="rating-review">
                                <div class="pro-dec-rating">
                                    <?php for($i=0 ; $i < $products->productAvg ; $i++) {?>
                                        <i class="ion-android-star-outline theme-star"></i>
                                  <?php  } ?>

                                  <?php for($i=0 ; $i < 5-$products->productAvg ; $i++) {?>
                                ...
                                <div class="pro-dec-review">
                                    <ul>
                                        <li><?= $products->reveiwCount;?> Reviews </li>
                            ...
                            <span>$260.00</span>
                            <div class="in-stock">
                                <p>Available: <span><?= (($products->quantity == '0') ? 'out of stock': 'in stock'); ?></span></p>
                            </div>
                            <p><?= $products->reveiwCount ; ?></p>
                    ...
                    <div class="tab-content description-review-bottom">
                        ...
                        <div id="des-details3" class="tab-pane">
                            <div class="rattings-wrapper">
                                <?php 
                                $reviewBeforeFetch = $pro->productReview();
                                if($reviewBeforeFetch){
                                    $reviews = $reviewBeforeFetch->fetch_all(MYSQLI_ASSOC);
